...
function Education()
{
    ...
    return(
        <div>
            ...
            <TextField required id="outlined-basic" label="Start Date" variant="outlined" onChange={handleExpStart}/>
            <TextField required id="outlined-basic" label="End Date" variant="outlined" onChange={handleExpEnd}/>
